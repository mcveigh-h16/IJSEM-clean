...
def cloudflare_challenge_present(html: str) -> bool:
    markers = [
        "Just a moment...",
...
# Prefer an explicit Chrome 146 binary if available. You can override these with:
#   setenv CHROME_BIN /full/path/to/chrome
#   setenv CHROMEDRIVER_BIN /full/path/to/chromedriver
chrome_candidates = [
    os.environ.get("CHROME_BIN"),
    "/home/mcveigh/.cache/selenium/chrome/linux64/146.0.7680.76/chrome",
    "/home/mcveigh/.cache/selenium/chrome/linux64/146.0.7680.76/chrome/google-chrome",
...
if chrome_path is None:
    raise FileNotFoundError(
        "No usable Chrome binary found. Set CHROME_BIN to the Chrome 146 binary path."
    )

chromedriver_candidates = [
    os.environ.get("CHROMEDRIVER_BIN"),
    "/home/mcveigh/.cache/selenium/chromedriver/linux64/146.0.7680.76/chromedriver",
    "/home/mcveigh/.cache/selenium/chromedriver/linux64/146.0.7680.76/chromedriver.exe",
...
for filtered_url in filtered_urls:
    ...
    options.add_argument("--headless")  # keep browser visible for manual Cloudflare completion
    ...
    if chromedriver_path:
        ...
        print("Using Selenium-managed chromedriver")
    ...
    # Try to accept any cookie banner before proceeding.
    ...
    if cloudflare_challenge_present(html):
        print("Cloudflare challenge detected. Solve it in the browser, then press Enter to continue.")
        input()
    time.sleep(2)
